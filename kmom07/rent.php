...
FROM Movie_kmom07 AS M
LEFT OUTER JOIN Movie2Genre_kmom07 AS M2G
	ON M.id = M2G.idMovie
...
// Prepare page before rendring
 
$goofy['main'] = <<<EOD
<h1>Filmer som finns att hyra</h1>
<div>
    <form method="get">
        <fieldset>
          <legend>Sök</legend>
